			...
			<tbody>
				<c:forEach items="${dataTableList}" var="dataTableList" varStatus="varStatus">
					<tr>
						...
						<td  width="9%" id="tdfield2"><c:out value="${dataTableList.workType}"/></td>
              ...
              <div class="common-container">
                ...
                <div class="form">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 sidebar-offcanvas">
                     <div class="form-group">
                          <label for="datefrom">Work Type<r>*</r></label>
                          <input type="text" class="form-control" id="workType" placeholder="Work Type" name="workType" maxlength="100"/>
                        </div>

...
<script type="text/javascript">
	...
	var vehicleTypeCode=$("#vehicleTypeCode").val().trim();
	
	
	
	    if (vehicleTypeCode == "") {
			warningMessageOnDialog("Vehicle Type Code cannot be blank...");
			return false;
		}
...
<c:choose>
	...
	<div id="lookupdataGrid" class="userListClass">
		<div class="title1"><h4>Vehicle Type</h4></div>
		<table id="userListTable" class="display" cellspacing="0" width="100%" >
			<thead align="center">
				<tr>
				<th width="3%">Vehicle Type ID</th>
                <th width="9%">Vehicle Type Code</th>
               
                <th width="14%">Vehicle Type Desc</th>
			...
			<tbody>
				<c:forEach items="${dataTableList}" var="dataTableList" varStatus="varStatus">
					<tr>
						<td width="3%" id="tdsrNoId"><c:out value="${dataTableList.vehicleTypeId}"/></td>
						<td  width="9%" id="tdfield2"><c:out value="${dataTableList.vehicleTypeCode}"/></td>

						<td  width="9%" id="tdfield4"><c:out value="${dataTableList.vehicleDescription}"/></td>
        ...
        <section id="lookupsForm">
              <div class="common-container">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 sidebar-offcanvas">
                        ...
                        <div class="form-group">
                          <label for="rateCode">VehicleType Code<r>*</r></label>
                          <input type="text" class="form-control" id="vehicleTypeCode" name="vehicleTypeCode" placeholder="Vehicle Code" maxlength="100">
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 sidebar-offcanvas">
                   <div class="form-group">
                          <label for="rateDesc">Vehicle Desc<r>*</r></label>
                          <input type="text" class="form-control" id="vehicleDescription" placeholder="Description" name="vehicleDescription" maxlength="100"/>
                        </div>
                ...
                <div class="controls alR">
                      ...
                      <input type="button" onclick="createNewLookups('addVehicleType');" class="btn btn-primary" value="Add" />
                     </div>
                </form>
              </div>
            </section>
